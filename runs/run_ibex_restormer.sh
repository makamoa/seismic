...
python train.py --model=restormer --problem=firstbreak --noise_type=2 --noise_scale=2.0 --device=0 --epochs=30 --pretrained=restormer_denoise_noisetype_2_noisescale_2.0_dataclip_False_attack_none_pretrained_False.pkl
