...
# linear_noise = [add_linearnoise(v=np.random.uniform(low=100, high=120, size=None),
#                                          tsample=np.random.uniform(low=0.05, high=0.08, size=None),
#                                          slope=np.random.uniform(low=7, high=13, size=None),
#                                          ampli=np.random.uniform(low=3.5, high=3.55, size=None))]
#
# complex_noise_transforms = [add_gaussnoise(noisestd=np.random.uniform(low=5, high=10, size=None)),
...
#                           add_blurnoise(ksizemax=int(np.random.uniform(low=3, high=5, size=None))),
#                           add_spnoise(percentage=np.random.uniform(low=5, high=10, size=None)),
#                           add_specklenoise(noiselevel=np.random.uniform(low=0.5, high=1.0, size=None)),
