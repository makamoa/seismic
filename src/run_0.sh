...
#
#python train.py --model=unet --problem=firstbreak --noise_type=4 --noise_scale=0.25 --device=0 --epochs=30
#python train.py --model=unet --problem=firstbreak --noise_type=4 --noise_scale=0.5 --device=0 --epochs=30
#python train.py --model=unet --problem=firstbreak --noise_type=4 --noise_scale=1.0 --device=0 --epochs=30
#python train.py --model=unet --problem=firstbreak --noise_type=4 --noise_scale=2.0 --device=0  --epochs=30
##
python train.py --model=unet --problem=firstbreak --noise_type=5 --noise_scale=0.25 --device=0 --epochs=30
python train.py --model=unet --problem=firstbreak --noise_type=5 --noise_scale=0.5 --device=0 --epochs=30
python train.py --model=unet --problem=firstbreak --noise_type=5 --noise_scale=1.0 --device=0 --epochs=30
python train.py --model=unet --problem=firstbreak --noise_type=5 --noise_scale=2.0 --device=0  --epochs=30
##
