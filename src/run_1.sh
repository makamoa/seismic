...
#
#
python train.py --model=unet --problem=denoise --noise_type=4 --noise_scale=0.25 --device=1 --epochs=50
python train.py --model=unet --problem=denoise --noise_type=4 --noise_scale=0.5 --device=1 --epochs=50
python train.py --model=unet --problem=denoise --noise_type=4 --noise_scale=1.0 --device=1 --epochs=50
python train.py --model=unet --problem=denoise --noise_type=4 --noise_scale=2.0 --device=1  --epochs=50
##
python train.py --model=unet --problem=denoise --noise_type=5 --noise_scale=0.25 --device=1 --epochs=50
python train.py --model=unet --problem=denoise --noise_type=5 --noise_scale=0.5 --device=1 --epochs=50
python train.py --model=unet --problem=denoise --noise_type=5 --noise_scale=1.0 --device=1 --epochs=50
python train.py --model=unet --problem=denoise --noise_type=5 --noise_scale=2.0 --device=1  --epochs=50
