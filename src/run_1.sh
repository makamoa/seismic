...
#
python train.py --model=swin --problem=denoise --noise_type=3 --noise_scale=0.25 --device=1 --epochs=25 --dataclip=False
python train.py --model=swin --problem=denoise --noise_type=3 --noise_scale=0.25 --device=1 --epochs=25
#
